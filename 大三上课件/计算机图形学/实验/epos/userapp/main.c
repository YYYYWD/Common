...
void __main()
{
    size_t heap_size = 32*1024*1024*1024*1024;
...
void Fill_test()
{
    while(1)
    {
            if(my_control%2==0)
        {
            ...
            char c[]="--------- Seed Fill ---------";
            my_printf(c,strlen(c),RGB(255,0,0),0,0);
            BoundaryFill4(count[0]+5,count[1]+10,1,2);
            clean_screen();
            char a[]="------- Please choose -------";
            my_printf(a,strlen(a),RGB(255,0,255),0,0);
            int key=getchar();
            if(key==0x0F09)//tab
            {
                my_control++;
        ...
        else if(my_control%2==1)
        {
            char c[]="---------  LineCUT  ---------";
            my_printf(c,strlen(c),RGB(255,255,0),0,0);

            control_CUT();
            char a[]="--------- Seed Fill ---------";
            my_printf(a,strlen(a),RGB(255,0,0),0,0);
        }
    }
}
...
void main(void *pv)
{
    ...
    //control();
    //DDAline2(60,60,500,467,RGB(255,255,255));
